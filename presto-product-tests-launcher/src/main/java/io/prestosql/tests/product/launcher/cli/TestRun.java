            ...
            implements Runnable
    {
            ...
            environment.configureContainer("tests", container -> {
                        ...
                        container
                                ...
                                .withCommand(ImmutableList.<String>builder()
                                        // TODO pre-install `nc`
                                        .add("bash", "-xeuc", "yum install -y nc; nc -l \"$1\" < /dev/null; shift; exec \"$@\"", "-")
                                        ...
                                        .add(
                                                ...
                                                "-Djava.util.logging.config.file=/docker/files/conf/tempto/logging.properties",
                                                ...
                                                "--config", String.join(",", ImmutableList.<String>builder()
                                                        ...
                                                        .add("/docker/files/conf/tempto/tempto-configuration-for-docker-default.yaml")
                                                        .add(System.getenv().getOrDefault("TEMPTO_ENVIRONMENT_CONFIG_FILE", "/dev/null"))
                                                        .add(System.getenv().getOrDefault("TEMPTO_PROFILE_CONFIG_FILE", "/dev/null"))
        ...
        private void runTests(Environment environment)
        {
            ...
            try {
                ...
                log.info("Test container %s is in state %s with exitCode %s", containerInfo.getId(), containerState, exitCode);
